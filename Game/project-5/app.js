...
//this.sound.src="../images/Ice attack 2.wav"
...
ctx.drawImage(this.image,this.frame*this.spriteWidth,0,this.spriteWidth,this.spriteHeight,this.x,this.y,this.width,this.height);
    ...
    this.frame=0;
    this.sound=new Audio();
    this.sound.src='./Ice_attack2.wav';
    this.frameInterval=200;
    this.markedForDeletion=false;
    ...
    collisonCtx.fillStyle=this.color;
    collisonCtx.fillRect(this.x,this.y,this.width,this.height);
    ctx.drawImage(this.image,0,0,this.spriteWidth,this.spriteHeight,this.x,this.y-this.size/4,this.width,this.height);
    }
    }
